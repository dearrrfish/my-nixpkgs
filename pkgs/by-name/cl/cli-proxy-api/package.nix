{
  ...
  sources = {
    x86_64-linux = {
      ...
      hash = "sha256-lA5/ofEns6QeeShG3pPYTrBLkuzCIfZMhkqVTTlNS9Y=";
    };
    aarch64-linux = {
  ...
  srcConfig = sources.${stdenv.hostPlatform.system} or (throw "Unsupported system: ${stdenv.hostPlatform.system}");
in
  stdenv.mkDerivation {
    pname = "cli-proxy-api";
    inherit version;
